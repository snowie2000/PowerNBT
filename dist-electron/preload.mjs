...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  nbt: {
    parse: (bytes, littleEndianHint) => electron.ipcRenderer.invoke("nbt:parse", bytes, littleEndianHint),
    serialize: (pnbt, littleEndian) => electron.ipcRenderer.invoke("nbt:serialize", pnbt, littleEndian)
  }
});
